...
public class NaiveBayes {
    ...
    public static void prepareTrainData(String trainFile) {
        //String path = "/Users/asishaddepalli/Downloads/ex1_train.csv";
        ...
        if(!records.isEmpty()) {
            for (int i = 0; i < records.size(); i++) {
                ...
                if(!tempList.isEmpty()) {
                    ...
                    //labelSet.add(tempList.get(tempList.size() - 1));
                }
            }
        }
    ...
    public static void prepareTestData(String testFile) {
        //List<List<String>> records = KnnSolver.readData("/Users/asishaddepalli/Downloads/ex1_test.csv");
    ...
    public static void test(int laplacian){
        ...
        generateScoreSet();
        //System.out.println(scoreSetMap);
    ...
    public static void calculateRecallBase(){
        ...
        //System.out.println(recallBase);
        //System.out.println(precisionBase);
    }
    ...
    public static void generateValueList(String test, List<String> testValue, int laplacian, Map<String, Double> matchMap){
        ...
        for (int i = 0; i < testData.get(0).size()-1; i++) {
            ...
            //System.out.println("P(C="+test + "/A"+ i + "=" + label + ") = " + count + "/" + Collections.frequency(trainLabels,test));
        ...
        if(null != values){
            ...
            for(String key : scoreSetMap.keySet()){
                if(test.equals(key)){
                    ...
                    //naiveBayes.add(String.valueOf(cal));
    ...
    public static void getRowCount(){
        for (int i = 0; i < trainData.get(0).size()-1; i++) {
            ...
            if(trainData.get(i).size() == trainData.get(0).size()) {
                for (int j = 0; j < trainData.size(); j++) {
                    //System.out.print(trainData.get(j).get(i)+" ");
